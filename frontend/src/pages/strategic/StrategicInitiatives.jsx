            ...
            <div className="grid md:grid-cols-3 gap-6 mt-8">
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <p className="text-md leading-relaxed">
                  We work closely with individuals who share the same passion
                  for protecting and conserving our natural resources,
                  particularly our beetle species. We are open to various forms
                  of sponsorship. The terms of engagement are subject to the
                  approval of the board and our legal team.
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <p className="text-md leading-relaxed">
                  We also work with philanthropists whose personal endowment
                  fund can be used to support the scientific activities of the
                  organization. This includes, but is not limited to, support in
                  fieldwork activities, support for laboratory works, and, in
                  turn, the funder can have a species named after his/her
                  liking, as long as it follows the convention of the
                  International Code of Zoological Nomenclature,
                  https://code.iczn.org/. The terms of engagement are subject to
                  the approval of the board and our legal team.
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <p className="text-md leading-relaxed">
                  ...
                  organizations that wish to provide scholarship opportunities
                  for students in both undergraduate and graduate programs who
                  will focus on the study of Philippine coleopterology. The
                  terms of engagement are subject to the approval of the board
                  and our legal team.
                </p>
              </div>
            </div>
