    ...
    <Container className="py-20 flex flex-nowrap  items-center gap-20">
      <div className="space-y-3 w-2/3">
        ...
        <p className="leading-relaxed text-lg">
          ...
          odio! Perferendis architecto reprehenderit ipsam, nobis at tenetur sed
          rem mollitia pariatur porro numquam doloribus sapiente itaque corrupti
          asperiores facilis assumenda tempore sint suscipit magni voluptas
          expedita cum. Possimus, laboriosam vitae?
        </p>
